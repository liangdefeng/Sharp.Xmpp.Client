...
namespace Sharp.Xmpp.Core.Sasl.Mechanisms
{
    ...
    internal class SaslScramSha256 : SaslMechanism
    {
        ...
        /// <summary>
        /// Scram-Sha-256 involves several steps.
        /// </summary>
        private int Step = 0;
        ...
        /// <summary>
        /// The IANA name for the Scram-Sha-256 authentication mechanism as described
        /// in RFC 7677
        /// </summary>
        ...
        /// <summary>
        /// Creates and initializes a new instance of the SaslScramSha256
        ...
        /// <summary>
        /// Computes the client response to the specified SCRAM-SHA-256 challenge.
        /// </summary>
        /// <param name="challenge">The challenge sent by the server</param>
        /// <returns>The response to the SCRAM-SHA-256 challenge.</returns>
        ...
        /// <summary>
        /// Applies the cryptographic hash function SHA-256 to the specified data
        /// array.
        /// </summary>
